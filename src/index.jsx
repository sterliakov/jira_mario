...
//         fieldsData &&
//         fieldsData.filter((field) => field.name === 'Sprint')[0].key;
...
//         (issueLink) =>
//             issueLink.link.inwardIssue.fields.status.statusCategory.key !==
//             'done',
//     );
...
//                     {numberOfUnhealthyParams}/3 health issues
//                 </Text>
//             )}
//         </Fragment>
//     );
...
//                     appearance={
//                         numberOfUnresolvedLinks > 0 ? 'removed' : 'inprogress'
//                     }
//                 />{' '}
//                 <Strong>
//                     Issue{pluralizeString(numberOfUnresolvedLinks)} in
//                     unresolved status
//                 </Strong>
//             </Text>
...
//                                     <Text>
//                                         <Link
//                                             href={`${serverData.baseUrl}/browse/${linkedIssueKey}`}
//                                         >
//                                             {linkedIssueKey}
//                                         </Link>
//                                     </Text>
...
//                                         <StatusLozenge
//                                             text={statusKey}
//                                             appearance={mapIssueStatusToLozengeAppearance(
//                                                 statusKey,
//                                             )}
//                                         />
//                                     </Text>
...
//                     appearance={
//                         daysFromLastUpdate >= 7 ? 'removed' : 'inprogress'
//                     }
//                 />
//             </Text>
//             <Table>
...
//                     <Cell>
//                         <Text>
//                             {format(new Date(created), storageData.timeConfig)}
//                         </Text>
//                     </Cell>
//                 </Row>
//             ))}
