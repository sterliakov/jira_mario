...
export default function Editor() {
    ...
    this.showElements = function () {
        const elementWrapper = (this.elementWrapper = view.create('div'));
    ...
    */
    ...
    this.saveMap = function () {
        ...
        const levelName =
            'savedLevel' + (levelCounter < 10 ? '0' : '') + levelCounter;
    ...
    this.removeEditorScreen = function () {
        if (viewPort) {
            ...
            view.style(this.elementWrapper, {display: 'none'});
        }
    };
    ...
    this.showEditorScreen = function () {
        if (viewPort) {
            view.style(viewPort, {display: 'block'});
            view.style(this.elementWrapper, {display: 'block'});
        }
    };
}
